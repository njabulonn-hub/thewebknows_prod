...
accuracy:"This value is known because it is the exact IPv4 address your connection broadcasts to every site you visit.",
...
accuracy:"This is known when your ISP enables IPv6. If nothing appears, your provider is not broadcasting IPv6 to the web.",
...
accuracy:"This information is known and drawn from public routing databases that map IP ranges to ISPs.",
...
accuracy:"This is inferred from commercial geolocation databases and can be wrong, especially when you use VPNs or corporate routes.",
...
accuracy:"Referrer values are known because browsers send them automatically unless a privacy control removes the header.",
...
accuracy:"This is an educated guess based on naming patterns and may mislabel niche or newly announced networks.",
...
accuracy:"It is known only if your ISP publishes a reverse DNS record; many residential IPs do not have one.",
